...
layout = html.Div(
    [
        ...
        html.Div(
            "Fill out the table and download the json file. This is only a help to write the wallet data into a structured format that then can be used to look up the adresses"
        ),
        html.Br(),
        html.Br(),
        ...
        html.Div(
            html.Button("Convert wallet overview", id="download-button", n_clicks=0)
        ),
